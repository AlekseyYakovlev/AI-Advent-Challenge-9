...
def build_chat_settings(
    ...
    *,
    ...
    from app.chainlit.components import lmstudio_settings_widgets
    ...
    if current.provider == "lmstudio" and lm_state is not None:
        widgets.extend(
            lmstudio_settings_widgets(
    ...
    widgets.extend(
        [
            ...
            Slider(
                ...
                initial=float(min(current.max_tokens, 4096)),
                min=64.0,
                max=4096.0,
                step=64.0,
            ),
